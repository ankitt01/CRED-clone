...
const ScreenText = ({ screen, setCurrentImg, i }) => {
  ...
  return (
    <div className={`pb-0 md:pb-[80px] screen-text ${isVisible ? "text-visible" : ""}`} ref={ref}>
      <div className="screen-heading pb-8 pl-4 lg:p-0">{screen.heading}</div>
      ...
      <div className="screen-description pb-8 pl-4 lg:p-0">{screen.description}</div>
    </div>
  );
};
