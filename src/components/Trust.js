...
const Trust = () => {
  return (
    <div>
        <div className={`h-screen flex flex-col justify-between bg-smTrust md:bg-trust bg-cover bg-center p-4 pl-12`}>
            <div className='lg:w-1/2 lg:ml-20'>
                <h1 className='text-7xl pb-4 font-bold w-1/2 md:text-8xl md:w-4/5 pt-40'>we take your money matters seriously.</h1>
